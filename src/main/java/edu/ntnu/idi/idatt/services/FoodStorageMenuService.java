...
public class FoodStorageMenuService {
   ...
   */
  public FoodStorageMenuService(FoodStorage foodStorage, LocalDate currentDate) throws IllegalArgumentException {
    if (foodStorage == null) {
  ...
  public void caseAddGrocery() {
    ...
    try {
      ...
      final String category = InterfaceUtil.stringInput();
      System.out.print("Enter unit: ");
      final String unit = InterfaceUtil.stringInput();
      System.out.print("Enter amount: ");
      final double amount = InterfaceUtil.doubleInput();
      System.out.printf("Enter price (per %s) in NOK: ", unit);
      final double pricePerUnit = InterfaceUtil.doubleInput();
   ...
   * batch. The method then adds the batch to the grocery in the food storage with the provided name.
   *
   ...
   * <p>
   * The method iterates through all expired groceries in the food storage, and their batches, and removes the batches
   * of each grocery that have expired. If the grocery batch is expired on the current date, the method consumes the
   * whole amount of the grocery batch. If the grocery batch is not expired, the method does not
   * remove the grocery batch.
   */
