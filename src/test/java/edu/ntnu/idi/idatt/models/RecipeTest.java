...
class RecipeTest {
  /**
   * Positive tests for the Recipe class.
   */
  @Nested
  @DisplayName("Positive tests for the Recipe class")
  class PositiveRecipeTests {

    /**
     * Test creating a recipe with valid parameters, and ensure accessor methods for all fields
     * return the correct values.
     */
    @Test
    @DisplayName(
        "Test creating a recipe with valid parameters, and ensure accessor methods for all "
  ...
  /**
   * Negative tests for the Recipe class.
   */
  @Nested
  @DisplayName("Negative tests for the Recipe class")
  class NegativeRecipeTests {
    /** The recipe object to use in many of the negative tests. */
    Recipe recipe = new Recipe("Steak with Potatoes", "A delicious dish that has "
        + "Steak and Potatoes.", "These are instructions", 3);

    /**
     * Test creating a recipe with the parameter {@code name} set to {@code null} or an empty
    ...
    /**
     * Test creating a recipe with the parameter {@code instructions} set to {@code null} or an
    ...
    @Test
    @DisplayName(
        "Test getting the ingredient with the name null or an empty string. Check for thrown "
    ...
    /**
     * Test getting an ingredient that does not exist. Check for thrown
    ...
    /**
     * Test setting the instructions of a recipe to {@code null} or an empty string. Check for
     * thrown {@code IllegalArgumentException} in the cases specified.
     */
    @Test
    ...
    /**
     * Test setting the number of servings of a recipe to less than or equal to zero. Check for
     * thrown {@code IllegalArgumentException} in the case specified.
     */
    @Test
