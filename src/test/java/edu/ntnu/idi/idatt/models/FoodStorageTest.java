...
class FoodStorageTest {
  ...
  /**
   * Positive tests for the FoodStorage class.
   */
  @Nested
  @DisplayName("Positive tests for the FoodStorage class")
  class PositiveFoodStorageTests {
  ...
  /**
   * Negative tests for the FoodStorage class.
   */
  @Nested
  @DisplayName("Negative tests for the FoodStorage class")
  class NegativeFoodStorageTests {
    /** The food storage object to use in the negative tests. */
    static final FoodStorage foodStorage = new FoodStorage();
    ...
    void testGetGroceriesExpiringBeforeDateNullThrows() {
      assertThrows(IllegalArgumentException.class,
          () -> foodStorage.getGroceriesExpiringBeforeDate(null));
    }
    ...
    void testGetGroceriesExpiringOnDateNullThrows() {
      assertThrows(IllegalArgumentException.class,
          () -> foodStorage.getGroceriesExpiringOnDate(null));
    }

    /**
     * Test that the method {@code addGrocery} throws an {@code IllegalArgumentException} when the
     * grocery is null.
     */
    @Test
    ...
    /**
     * Test that the method {@code addGrocery} throws an {@code IllegalArgumentException} when the
     * grocery already exists in the food storage.
     */
    @Test
    ...
    /**
     * Test that the method {@code removeGrocery} throws an {@code IllegalArgumentException} when the
     * grocery is null.
     */
    @Test
    ...
    /**
     * Test that the method {@code removeGrocery} throws an {@code IllegalArgumentException} when the
     * grocery does not exist in the food storage.
     */
    @Test
