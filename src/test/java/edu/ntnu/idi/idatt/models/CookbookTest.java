...
class CookbookTest {
  ...
  /**
   * Positive tests for the Cookbook class.
   */
  @Nested
  @DisplayName("Positive tests for the Cookbook class")
  class PositiveCookbookTests {
  ...
  /**
   * Negative tests for the Cookbook class.
   */
  @Nested
  @DisplayName("Negative tests for the Cookbook class")
  class NegativeCookbookTests {
    /** The cookbook object to use in the negative tests. */
    static final Cookbook cookbook = new Cookbook();

    /**
     * Set up the tests by adding a recipe to the cookbook.
     */
    @BeforeAll
    @DisplayName("Sets up the tests, by adding a recipe to the cookbook")
    static void setUp() {
      Recipe recipe = new Recipe("Test recipe", "Test description", "Test instructions", 1);
      cookbook.addRecipe(recipe);
    }
    ...
    /**
     * Test that the method {@code getRecipe} throws an {@code IllegalArgumentException} when the
     * name of the recipe is null or blank.
     */
    @Test
    ...
    /**
     * Test that the method {@code getRecipe} throws an {@code IllegalArgumentException} when no
     * recipe with the provided name is found.
     */
    @Test
    ...
    /**
     * Test that the method {@code addRecipe} throws an {@code IllegalArgumentException} when the
     * recipe is null.
     */
    @Test
    ...
    /**
     * Test that the method {@code addRecipe} throws an {@code IllegalArgumentException} when the
     * recipe already exists in the cookbook.
     */
    @Test
    ...
    /**
     * Test that the method {@code removeRecipe} throws an {@code IllegalArgumentException} when the
     * recipe is null.
     */
    @Test
